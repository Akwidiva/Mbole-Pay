      ...
      <div className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Share this code with people to invite them to join</CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              📋 Share this invite code with others. They can use it to join your group.
            </p>
          </CardContent>
        </Card>
